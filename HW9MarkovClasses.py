...
class PatientStateMonitor:
    ...
    def __init__(self, parameters):
        ...
        self._timeToStroke = 0        # time to suffer stroke
        self._ifSufferedStroke = False   # if the patient suffered stroke
...
class CohortOutputs:
    def __init__(self, simulated_cohort):
        ...
        for patient in simulated_cohort.get_patients():
            ...
            self._numbersofstrokes.append(patient.get_number_of_strokes())
        # summary statistics
    ...
    def get_numbers_of_strokes(self):
        return self._numbersofstrokes
